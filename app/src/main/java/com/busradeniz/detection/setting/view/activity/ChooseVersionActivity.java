...
import com.busradeniz.detection.setting.view.adapter.RcyChooseVersionAdapter;
            ...
            case R.id.rl_save:
                ...
                DialogUtils.setOnConfirmClickListener(new DialogUtils.IosDialogListener() {
                    ...
                    public void onConfirmClickListener(View view) {
                        Bundle bundle = new Bundle();
                        IntentUtils.startActivityForParms(ChooseVersionActivity.this, WorkingActivity.class, bundle);
                    }
                });
